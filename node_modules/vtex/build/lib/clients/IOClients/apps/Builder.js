...
class Builder extends api_1.AppClient {
    constructor(ioContext, opts) {
        ...
        this.relinkApp = (app, changes, linkID, params = {}) => {
            const headers = {
                ...(this.stickyHost && { [Headers_1.Headers.VTEX_STICKY_HOST]: this.stickyHost }),
        ...
        this.sendZipFile = async (route, app, zipFile, { tag, sticky, stickyHint } = {}, requestParams = {}, requestHeaders = {}) => {
            ...
            const { data, headers: { [Headers_1.Headers.VTEX_STICKY_HOST]: host }, } = await this.http.postRaw(route, zipFile, {
                headers: {
                    ...(sticky && { [Headers_1.Headers.VTEX_STICKY_HOST]: this.stickyHost || hint }),
                    ...requestHeaders,
